# RailsAdmin config file. Generated on April 04, 2013 20:04
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Alumni', 'Admin']
  ...
  # config.excluded_models = ['Education', 'Experience', 'Location', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Education', 'Experience', 'Location', 'User']
  ...
  #     configure :enrollment_date, :date 
  #     configure :graduation_date, :date 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your experience.rb model definition
  ...
  #     configure :group, :integer 
  #     configure :promotion, :integer 
  #     configure :temporary_profile, :integer 
  ...
  #     configure :longitude, :float 
  #     configure :gmaps, :boolean 
  #     configure :imageurl, :text 
  #     configure :specialization, :string 
  #     configure :linkedin_connected, :integer 
